...
const salesCfg: FlavorConfig = {
  ...
  partyKey: 'customer',
  partyLabel: 'العميل',
  viewPerm: 'salesreturns.view',
  createPerm: 'salesreturns.create',
  deletePerm: 'salesreturns.delete',
...
const purchaseCfg: FlavorConfig = {
  ...
  partyKey: 'supplier',
  partyLabel: 'المورد',
  viewPerm: 'purchasereturns.view',
  createPerm: 'purchasereturns.create',
  deletePerm: 'purchasereturns.delete',
